...
Samokodirnik je model, ki podatkovno množico preslika v prostor manjše razsežnosti, nato pa jo ponovno preslika v prvotni prostor. % TODO: bolj formalno
Če je rekonstruirana množica dober približek prvotne množice, sklepamo, da vmesni prostor ohrani večino informacij v množici in lahko vmesno množico uporabimo namesto prvotne. % razbit na dve povedi
...
% TODO: previdno ponovno branje - ali v tekstu okej teče rdeča nit? JE metoda strojnega učenja tukaj okej umeščena v besedilo?
...
Ta postopek pogosto opišemo z izrazom, da model naučimo na podatkovni množici. % TODO: rephrase
...
% TODO: še enkrat napisat odstavek
...
% (TODO: sklic na vir o kakšni standardni metodi učenja, npr.\ gradient descent)
...
% TODO: posvet z ljupčotom, kako bi ugotovili uradni prevod?
\begin{definicija}
...
\label{trd:prekletstvo_dim}
	...
	Naj slučajna spremenljivka $R_i$ označuje oddaljenost $i$-te točke od izhodišča in naj bo $Y$ statistika prvega reda naključnega vzorca $R_1, \ldots, R_n$. % to se da zagotovo lepše povedati
...
% prestavljeno. TODO: urediti vrstni red
% Razlaga trditve, kjer se navežemo na že omenjene probleme in pojasnimo, kako jih trditev utemelji.
...
% TODO: moramo še sklepati, kako iz tega izhaja, da je mediana večja od nečesa
...
% TODO: premisliti izraz "standarden" samokodirnik - in prilagoditi tekst/naslov razdelka
...
% TODO: definicija za indeks vektor al nekej takega???
\begin{definicija}
\label{def:model-nn}
...
% TODO: človeški opis tega, kaj se dogaja v definiciji
...
Računanje gradienta funkcije izgube, ki ga algoritem potrebuje, pa je za nevronske mreže zelo zamudno - za to uporabimo postopek \emph{vzvratnega širjenja napake} (ang.~backpropagation), ki je bolj učinkovit od direktnega izračuna. % TODO: vprašat ljupčota ali je to veljaven izraz - dat v emph
...
% TODO: se pogovoriti z ljupčotom o: več ciljnih spremenljivk VS. ena cilja spremenljivka, ki ima več kot eno razsežnost
...
% ============================= % TODO: prestavit za definicijo odločitvenega drevesa
...
Naključni gozd je posebna vrsta ansambla dreves. % TODO: dopolniti stavek
...
% TODO: poudarek, da vzamem liste iz GOZDA, ne nujno iz istega drevesa
...
%
V nadaljevanju privzamemo $\gamma = 1$ kot privzeto vrednost. % TODO: comment
...
% leftover v komentarju. TODO: yeet out?
...
% TODO: z ljupčotom se pogovorit o numeričnih vs. diskretnih vs. boolovih spremenljivkah
...
% TODO: skrajšati/preoblikovati preostali tekst po žiga navodilih

% TODO: opisati shemo delovanja
...
Pristop, ki se zdi pri tem najbolj obetaven je ``obrezovanje'' (ang. pruning) odločitvenega drevesa. % TODO: je to post pruning? kakšen sklic za tole?
...
Nato pa bi iz tega nabora izbrali $d_{code}$ kandidatov tako, da je med njimi čim manj prekrivanja. % TODO: urediti to $d_{code}$ oznako, da se povsod ujema
