...
% OLD ----------------------------------------
% Povemo katere podatke imamo glede kodirnega vektorja - napeljemo na SAT formulacijo
...
% ================================ STARO POGLAVJE - work in progress ================================ %
...
\begin{definicija}
	% \label{def-dekodiranje}
		...
		% def. preslika zakodirane primere pač v nekaj. Je sploh treba omenit kodirni vektor???
		...
		% TODO: probat napisat, da deluje na osnovi kodirnega vektorja v
		% ne moremo napisat enega pogoja, ki bi ustrezal SAT in tudi uporabi shranjenih napovedi...
		% če ne bo šlo z uredu formulacijo, se lahko naše želje omeni v okoliškem tekstu
...
% uporabimo funkcijo find\_negation\_candidate, ki jo ovijemo okoli DPLL algoritma in vrne vektor vrednosti, pri katerih formula velja
% maybe preimenovanje: DPLL\_example -> DPLL\_wrapper al neki
Če tak vektor ne obstaja, mora vsak primer podatkovne množice pripadati vsaj enemu listu in tako ne bomo nikoli rabili uporabiti algoritma DPLL\_example. % TODO: premisliti, razložiti malo bolj temeljito
...
\begin{itemize}
	...
	Privzeta vrednost parametra \texttt{default\_measure\_of\_diff} je $0.1$. % TODO: določiti privzeto vrednost
